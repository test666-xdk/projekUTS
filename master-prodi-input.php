...
if(isset($_GET['status'])){
    if($_GET['status'] == 'failed'){
        echo "<script>alert('Gagal menambahkan data kategopri. Silakan coba lagi.');</script>";
    }
}
                                    ...
                                    <form action="proses/proses-prodi.php?aksi=inputprodi" method="POST">
									    <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="angka" class="form-control" id="kode" name="id" placeholder="Masukkan id kategori" required>
                                            </div>
											<div class="mb-3">

			...
			<main class="app-main">
				...
				<div class="app-content-header">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="mb-0">Aplikasi SICMEBEL</h3>
							</div>
							<div class="col-sm-6">
							...
							<div class="col-12">
								<div class="card">
									...
									<div class="card-header">
										<h3 class="card-title">Selamat Datang Di Mebel Saya!</h3>
									...
									<div class="card-body">
										<p>Halo Para pelanggan! disini saya membuat sistem pemesanan online mebel di mana mempermudah para pelanggan memesan produk !</p>
										<p>Silakan pilih salah satu tombol untuk memulai!</p>
										<a href="data-input.php" class="btn btn-primary btn-lg"><i class="bi bi-clipboard-data-fill"></i> Input Data Produk</a>
